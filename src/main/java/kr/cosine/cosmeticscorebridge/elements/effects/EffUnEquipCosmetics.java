...
public class EffUnEquipCosmetics extends Effect {

    static {
        Skript.registerEffect(EffUnEquipCosmetics.class, "unequip %object% from %player%");
    }
    ...
    protected void execute(Event event) {
        ...
        cosmeticsService.unequipCosmetics(cosmeticsKey, player);
    }
